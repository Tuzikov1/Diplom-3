...
public class LoginPage {
    ...
    //Инпут Email
    private final By emailInput = By.xpath(".//input[@class='text input__textfield text_type_main-default' and @type='text']");
    //Инпут Password
